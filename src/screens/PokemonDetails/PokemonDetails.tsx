...
function PokemonDetails() {
  ...
  const backgroundColorByType = getColorByType(pokemon.types[0]);
  ...
  return (
    <ScrollView flex={1} bg={backgroundColorByType} py={4} px={2} >
          <Image
        ...
        <HStack justifyContent={"space-between"}>
            ...
            <Heading p={4} size="md" fontWeight="bold" textAlign={"center"} color={backgroundColorByType}>About</Heading>
            ...
            <Heading p={4} size="md" fontWeight="bold" textAlign={"center"} color={backgroundColorByType}>Base Stats</Heading>

            <VStack px={5} pb={5} space={4}>
                <HStack  space={4}>
                    <VStack alignItems="flex-end">
                        <Text fontWeight="bold" color={backgroundColorByType}>HP</Text>
                        <Text fontWeight="bold" color={backgroundColorByType}>ATK</Text>
                        <Text fontWeight="bold" color={backgroundColorByType}>DEF</Text>
                        <Text fontWeight="bold" color={backgroundColorByType}>SATK</Text>
                        <Text fontWeight="bold" color={backgroundColorByType}>SDEF</Text>
                        <Text fontWeight="bold" color={backgroundColorByType}>SPD</Text>
                    </VStack>
                    ...
                    <VStack flex={1} space={3.5} pt={1}>
                        <Progress value={pokemon.stats.hp} max={255} _filledTrack={{bg: backgroundColorByType}}/>
                        <Progress value={pokemon.stats.attack} max={255} _filledTrack={{bg: backgroundColorByType}}/>
                        <Progress value={pokemon.stats.defense} max={255} _filledTrack={{bg: backgroundColorByType}}/>
                        <Progress value={pokemon.stats.specialAttack} max={255} _filledTrack={{bg: backgroundColorByType}}/>
                        <Progress value={pokemon.stats.specialDefense} max={255} _filledTrack={{bg: backgroundColorByType}}/>
                        <Progress value={pokemon.stats.speed} max={255} _filledTrack={{bg: backgroundColorByType}}/>
                    </VStack> 
                </HStack>
            </VStack>
        </Box>
